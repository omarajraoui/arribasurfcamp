...
const FloatingContactButtons = () => {
  ...
  <div className="fixed bottom-4 right-4 flex flex-col items-end gap-3 z-40">
      <a
        ...
        aria-label="WhatsApp"
    className="group w-14 h-14 rounded-full bg-[#25D366] hover:brightness-105 text-white flex items-center justify-center shadow-subtle relative overflow-hidden transition-all focus:outline-none focus:ring-2 focus:ring-brand-sun/40"
      >
      ...
      <a
        href={emailLink}
        aria-label="Email"
        className="group w-14 h-14 rounded-full bg-brand-sun hover:brightness-110 text-brand-ink flex items-center justify-center shadow-subtle relative overflow-hidden transition-all focus:outline-none focus:ring-2 focus:ring-brand-sun-soft/60"
      >
        <svg viewBox="0 0 24 24" className="w-7 h-7" fill="currentColor" aria-hidden="true">
